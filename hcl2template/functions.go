...
func Functions() map[string]function.Function {
	...
	funcs := map[string]function.Function{
		...
		"tostring":         unimplFunc, // funcs.MakeToFunc(cty.String),
		"tonumber":         unimplFunc, // funcs.MakeToFunc(cty.Number),
		"tobool":           unimplFunc, // funcs.MakeToFunc(cty.Bool),
		"toset":            unimplFunc, // funcs.MakeToFunc(cty.Set(cty.DynamicPseudoType)),
		"tolist":           unimplFunc, // funcs.MakeToFunc(cty.List(cty.DynamicPseudoType)),
		"tomap":            unimplFunc, // funcs.MakeToFunc(cty.Map(cty.DynamicPseudoType)),
