...
func (f *Future) WaitForCompletion(ctx context.Context, client autorest.Client) (err error) {
	ctx = tracing.StartSpan(ctx, "github.com/Azure/go-autorest/autorest/azure/async.WaitForCompletion")
	defer func() {
		sc := -1
		resp := f.Response()
		if resp != nil {
