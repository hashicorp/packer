...
const BuilderId = "packer.googlecomputesurrogate"
...
func (b *Builder) Run(ctx context.Context, ui packer.Ui, hook packer.Hook) (packer.Artifact, error) {
	...
	if _, exists := b.config.Metadata[gcp.StartupScriptKey]; exists || b.config.StartupScriptFile != "" {
	...
	artifact := &Artifact{
		image:     state.Get("image").(*gcp.Image),
		driver:    driver,
		config:    &b.config,
