// Code generated by "mapstructure-to-hcl2 -type Config,DiskConfig"; DO NOT EDIT.
package surrogate
...
type FlatConfig struct {
	...
	BootDisk                     *FlatDiskConfig                `mapstructure:"boot_disk" required:"false" cty:"boot_disk" hcl:"boot_disk"`
	TargetDisk                   *FlatDiskConfig                `mapstructure:"target_disk" required:"false" cty:"target_disk" hcl:"target_disk"`
	...
	ImageEncryptionKey           *gcp.FlatCustomerEncryptionKey `mapstructure:"image_encryption_key" required:"false" cty:"image_encryption_key" hcl:"image_encryption_key"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"boot_disk":                       &hcldec.BlockSpec{TypeName: "boot_disk", Nested: hcldec.ObjectSpec((*FlatDiskConfig)(nil).HCL2Spec())},
		"target_disk":                     &hcldec.BlockSpec{TypeName: "target_disk", Nested: hcldec.ObjectSpec((*FlatDiskConfig)(nil).HCL2Spec())},
		...
		"image_encryption_key":            &hcldec.BlockSpec{TypeName: "image_encryption_key", Nested: hcldec.ObjectSpec((*gcp.FlatCustomerEncryptionKey)(nil).HCL2Spec())},
...
type FlatDiskConfig struct {
	...
	SizeGb *int64  `mapstructure:"size" required:"false" cty:"size" hcl:"size"`
