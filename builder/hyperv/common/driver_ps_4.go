...
func (d *HypervPS4Driver) CopySourceVirtualMachine(sourcePath string, vmName string, path string) error {
	return hyperv.CopySourceVirtualMachine(sourcePath, vmName, path)
}
