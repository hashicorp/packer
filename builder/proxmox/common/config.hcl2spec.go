// Code generated by "mapstructure-to-hcl2 -type Config,nicConfig,diskConfig,vgaConfig,additionalISOsConfig,cdFilesConfig"; DO NOT EDIT.
...
type FlatConfig struct {
	...
	CDFilesConf               *FlatcdFilesConfig         `mapstructure:",cd_files_config" cty:"cd_files_conf" hcl:"cd_files_conf"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"cd_files_conf":                &hcldec.BlockSpec{TypeName: "cd_files_conf", Nested: hcldec.ObjectSpec((*FlatcdFilesConfig)(nil).HCL2Spec())},
	}
	return s
}
...
// FlatcdFilesConfig is an auto-generated flat version of cdFilesConfig.
// Where the contents of a field with a `mapstructure:,squash` tag are bubbled up.
type FlatcdFilesConfig struct {
	Device         *string `mapstructure:"device" cty:"device" hcl:"device"`
	ISOStoragePool *string `mapstructure:"iso_storage_pool" cty:"iso_storage_pool" hcl:"iso_storage_pool"`
	Unmount        *bool   `mapstructure:"unmount" cty:"unmount" hcl:"unmount"`
}

// FlatMapstructure returns a new FlatcdFilesConfig.
// FlatcdFilesConfig is an auto-generated flat version of cdFilesConfig.
// Where the contents a fields with a `mapstructure:,squash` tag are bubbled up.
func (*cdFilesConfig) FlatMapstructure() interface{ HCL2Spec() map[string]hcldec.Spec } {
	return new(FlatcdFilesConfig)
}

// HCL2Spec returns the hcl spec of a cdFilesConfig.
// This spec is used by HCL to read the fields of cdFilesConfig.
// The decoded values from this spec will then be applied to a FlatcdFilesConfig.
func (*FlatcdFilesConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		"device":           &hcldec.AttrSpec{Name: "device", Type: cty.String, Required: false},
		"iso_storage_pool": &hcldec.AttrSpec{Name: "iso_storage_pool", Type: cty.String, Required: false},
		"unmount":          &hcldec.AttrSpec{Name: "unmount", Type: cty.Bool, Required: false},
