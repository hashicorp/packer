...
type FlatConfig struct {
	...
	SSHTemporaryKeyPairAlgorithm *string           `mapstructure:"temporary_key_pair_algorithm" required:"false" cty:"temporary_key_pair_algorithm" hcl:"temporary_key_pair_algorithm"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"temporary_key_pair_algorithm": &hcldec.AttrSpec{Name: "temporary_key_pair_algorithm", Type: cty.String, Required: false},
	}
	return s
}
