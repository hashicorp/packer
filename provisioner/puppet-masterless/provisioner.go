...
func (p *Provisioner) uploadHieraConfig(ui packersdk.Ui, comm packer.Communicator) (string, error) {
...
func (p *Provisioner) uploadManifests(ui packersdk.Ui, comm packer.Communicator) (string, error) {
