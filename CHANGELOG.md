...
* On May 16th 2023, HCP introduced multi-project support to the platform.
    ...
    Packer will pick the project with the oldest creation date. Older versions of Packer
    are incompatible with multi-project support on HCP, and builds may fail as a result.
