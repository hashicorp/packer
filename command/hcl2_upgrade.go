	...
	funcMap := texttemplate.FuncMap{
		...
		"lower": func(_ string) (string, error) {
			return "", UnhandleableArgumentError{
				"lower",
				"`lower(var.example)`",
				"https://www.packer.io/docs/hcl2/functions/string/lower",
			}
		},
		"upper": func(_ string) (string, error) {
			return "", UnhandleableArgumentError{
				"upper",
				"`upper(var.example)`",
				"https://www.packer.io/docs/hcl2/functions/string/upper",
			}
		},
		"split": func(_, _ string, _ int) (string, error) {
			return "", UnhandleableArgumentError{
				...
				"https://www.packer.io/docs/hcl2/functions/string/split",
			}
		},
		"replace": func(_, _, _ string, _ int) (string, error) {
			return "", UnhandleableArgumentError{
				...
				"https://www.packer.io/docs/hcl2/functions/string/replace or https://www.packer.io/docs/hcl2/functions/string/regex_replace",
			}
		},
		...
		"clean_resource_name": func(_ string) (string, error) {
			return "", UnhandleableArgumentError{
				...
				"https://packer.io/docs/hcl2/variables#custom-validation-rules" +
					" , https://www.packer.io/docs/hcl2/functions/string/replace" +
					" or https://www.packer.io/docs/hcl2/functions/string/regex_replace",
			}
		},
