...
# See https://www.packer.io/docs/hcl2/blocks/packer for more info
packer {
...
# https://www.packer.io/docs/hcl2/variables#type-constraints for more info.
...
# https://www.packer.io/docs/hcl2/blocks/source
...
# https://www.packer.io/docs/hcl2/blocks/build
build {
  ...
  # Visit https://packer.io/docs/hcl2/variables#custom-validation-rules , https://www.packer.io/docs/hcl2/functions/string/replace or https://www.packer.io/docs/hcl2/functions/string/regex_replace for more infos.
  provisioner "shell" {
  ...
  # Visit https://www.packer.io/docs/hcl2/functions/string/lower for more infos.
  provisioner "shell" {
  ...
  # Visit https://www.packer.io/docs/hcl2/functions/string/upper for more infos.
  provisioner "shell" {
  ...
  # Visit https://www.packer.io/docs/hcl2/functions/string/split for more infos.
  provisioner "shell" {
  ...
  # Visit https://www.packer.io/docs/hcl2/functions/string/replace or https://www.packer.io/docs/hcl2/functions/string/regex_replace for more infos.
  provisioner "shell" {
