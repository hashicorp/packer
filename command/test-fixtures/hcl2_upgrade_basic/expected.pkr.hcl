...
data "amazon-secretsmanager" "password" {
  name = "sample/app/password"
}

data "amazon-secretsmanager" "password_key" {
  key  = "api_key"
  name = "sample/app/passwords"
}

data "amazon-secretsmanager" "some_secret" {
  name = "some_secret"
}

data "amazon-secretsmanager" "some_secret_with_key" {
  key  = "with_key"
  name = "some_secret"
}
...
build {
  ...
  provisioner "shell" {
    inline = ["echo ${data.amazon-secretsmanager.password.value}", "echo ${data.amazon-secretsmanager.password.value}", "echo ${data.amazon-secretsmanager.password_key.value}", "echo ${data.amazon-secretsmanager.password_key.value}"]
  }
  provisioner "shell" {
    inline = ["echo ${data.amazon-secretsmanager.some_secret.value}", "echo ${data.amazon-secretsmanager.some_secret_with_key.value}"]
  }
