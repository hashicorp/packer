...
- `use_azure_cli_auth` (bool) - cli auth will use the information from an active `az login` session to connect to azure and set the subscription id and tenant id associated to the signed in account.
