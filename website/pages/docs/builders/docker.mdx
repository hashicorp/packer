...
This builder generates data that are shared with provisioner and post-processor via build function of [template engine](/docs/templates/engine)
...
- `ImageSha256` - When committing a container to an image, this will give the image SHA256.
