...
description: The aws_secretsmanager function retrieves secrets from Amazon 
secretsmanager stores.
---
...
build {
  ...
  provisioner "shell-local" {
    ...
    inline = ["echo my_version is '${local.my_version}'",
              "echo version is '${aws_secretsmanager_key("globalpassword", "version")}'."]
  }
}
```
