...
By opening an integration request, you are asking a member of the Packer team to review your plugin integration configuration, plugin documentation, 
and, finally, to open an internal pull-request to finalize the integration setup. 

Plugin integrations will be listed as a [Packer Integration](https://developer.hashicorp.com/packer/integrations), with details on how to install and use your plugin. 
...
In both these of cases, if the binary is called `packer-plugin-myawesomecloud` and
