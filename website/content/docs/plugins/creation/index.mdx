...
To make your unpublished plugin available to Packer, please refer to the following documentation that describes how packer loads and installs plugins [plugin load spec](/packer/docs/plugins/creation/plugin-load-spec).
