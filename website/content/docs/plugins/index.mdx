...
`darwin_amd64` system, using the full source path.

* `${PLUGIN_DIR}/github.com/azr/aws/packer-plugin-aws_2.7.0_darwin_amd64_x5`
* `${PLUGIN_DIR}/github.com/hashicorp/azure/packer-plugin-azure_2.7.0_darwin_amd64_x5`
