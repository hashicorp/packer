...
Here using the previous example if the required plugin `azr/aws` defined an 
`ebs` builder, this builder will be made available by using a `aws-ebs` source block :
