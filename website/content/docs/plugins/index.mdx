...
developing plugins, the documentation for that is available in the [developing
plugins](/docs/plugins/creation#developing-plugins) section.
...
block to your `packer` block, each block will tell Packer what versions can be
installed, make sure to set a correct [version constraint
string](/docs/templates/hcl_templates/blocks/packer#version-constraints). For
example:
