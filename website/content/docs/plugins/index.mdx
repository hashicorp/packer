...
such as builders, provisioners, hooks, and more.
...
in a similar way and treated as plugins.
...
block to your `packer` block. Each block will tell Packer what version(s) of a
particular plugin can be installed. Make sure to set a correct [version
