---
description: |
  The HCP Packer support allows plugins to manage image metadata that can be stored in a HCP Packer registry.
...
The HCP Packer support consists on management of image metadata that can be stored in a HCP Packer registry.
