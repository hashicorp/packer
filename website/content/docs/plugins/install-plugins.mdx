...
You do not need to install plugins for builder, provisioner, or
...
them. These instructions explain how to install custom components that are not
bundled with the Packer core.

Refer to [External Plugins](/plugins) for a list of available plugins and their documentation.

## Installation Guide

The tabs reference "multi-component" and "single-component" plugins. If
