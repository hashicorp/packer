...
![Packer Ecosystem Integration Diagram](/img/docs/packer-ecosystem-diagram.png "Packer Ecosystem Integration Diagram")
...
* Scaffolding plugin repository to help bootstrap a new contribution:
...
* [Example Builder](https://github.com/hashicorp/packer-plugin-hashicups/tree/main/buider/order)
Provisioners
...
* [Example Post-processor](https://github.com/hashicorp/packer-plugin-hashicups/tree/main/post-processor/receipts)
Packer-Plugin-SDK
