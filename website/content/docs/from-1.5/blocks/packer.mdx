...
current config, mapping each local provider name to a source address and a
version constraint.
...
For more information, see [Plugin
Requirements](/docs/from-1.5/plugin-requirements).
