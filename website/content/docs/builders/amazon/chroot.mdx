...
// There are other ways to [set variables](/docs/hcl2/variables#assigning-values-to-build-variables), including from a var
...
This builder generates data that are shared with provisioner and post-processor via build function of [template engine](/docs/templates/engine) for JSON and [contextual variables](/docs/hcl2/contextual-variables) for HCL2.
