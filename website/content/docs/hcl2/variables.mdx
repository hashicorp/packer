...
[expression](/docs/hcl2/expressions)).
...
within [expressions](/docs/hcl2/expressions) as `var.<NAME>`, where `<NAME>`
...
value](/docs/hcl2/expressions#types-and-values) that will be accepted as the value
...
[usual syntax](/docs/hcl2/expressions) can be used to assign
