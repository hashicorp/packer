...
[`try`](/docs/hcl2/functions/conversion/try) instead, because it allows for more concise definition of
...
prefer to use [`try`](/docs/hcl2/functions/conversion/try).
...
- [`try`](/docs/hcl2/functions/conversion/try), which tries evaluating a sequence of expressions and
