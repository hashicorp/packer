...
format" syntax. As a string. [`formatdate`](/docs/hcl2/functions/datetime/formatdate) still allows you
to format a date.
...
- [`formatdate`](/docs/hcl2/functions/datetime/formatdate) can convert the resulting timestamp to
