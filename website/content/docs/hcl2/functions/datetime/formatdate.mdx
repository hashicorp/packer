...
- [`format`](/docs/hcl2/functions/string/format) is a more general formatting function for arbitrary
  data.
- [`timestamp`](/docs/hcl2/functions/datetime/timestamp) returns the current date and time in a format
