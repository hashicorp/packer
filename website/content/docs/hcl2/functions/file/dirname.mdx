...
for transient values, such as the argument to [`file`](/docs/hcl2/functions/file) (where
...
- [`basename`](/docs/hcl2/functions/file/basename) returns _only_ the last portion of a filesystem
