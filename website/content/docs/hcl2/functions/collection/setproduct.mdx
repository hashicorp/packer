...
and
[`dynamic` block](/docs/hcl2/expressions/#dynamic-blocks)
...
- [`contains`](/docs/hcl2/functions/collection/contains) tests whether a given list or set contains
  a given element value.
- [`flatten`](/docs/hcl2/functions/collection/flatten) is useful for flattening heirarchical data
  into a single list, for situations where the relationships between two
  object types are defined explicitly.
- [`setintersection`](/docs/hcl2/functions/collection/setintersection) computes the _intersection_ of
  multiple sets.
- [`setunion`](/docs/hcl2/functions/collection/setunion) computes the _union_ of multiple
  sets.
