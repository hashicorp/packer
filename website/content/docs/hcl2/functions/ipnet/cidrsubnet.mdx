...
Unlike the related function [`cidrsubnets`](/docs/hcl2/functions/ipnet/cidrsubnets), `cidrsubnet`
...
While [`cidrhost`](/docs/hcl2/functions/ipnet/cidrhost) allows calculating single host IP addresses,
...
[`cidrhost`](/docs/hcl2/functions/ipnet/cidrhost) function to calculate those host addresses by
...
- [`cidrhost`](/docs/hcl2/functions/ipnet/cidrhost) calculates the IP address for a single host
  within a given network address prefix.
- [`cidrnetmask`](/docs/hcl2/functions/ipnet/cidrnetmask) converts an IPv4 network prefix in CIDR
  notation into netmask notation.
- [`cidrsubnets`](/docs/hcl2/functions/ipnet/cidrsubnets) can allocate multiple consecutive
