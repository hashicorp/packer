...
related function [`cidrsubnet`](/docs/hcl2/functions/ipnet/cidrsubnet). `cidrsubnet` calculates
...
[`for` expressions](/docs/hcl2/expressions#for-expressions)
...
- [`cidrsubnet`](/docs/hcl2/functions/ipnet/cidrsubnet) calculates a single subnet address, allowing
