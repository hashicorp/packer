...
[the same syntax as `format`](/docs/hcl2/functions/string/format#specification-syntax).
...
- [`format`](/docs/hcl2/functions/string/format) defines the specification syntax used by this
