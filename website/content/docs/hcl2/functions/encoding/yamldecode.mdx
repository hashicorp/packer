...
- [`jsondecode`](/docs/hcl2/functions/encoding/jsondecode) is a similar operation using JSON instead
  of YAML.
- [`yamlencode`](/docs/hcl2/functions/encoding/yamlencode) performs the opposite operation, _encoding_
  a value as YAML.
