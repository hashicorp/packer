...
representation of a value use [`jsonencode`](/docs/hcl2/functions/encoding/jsonencode) instead; its
...
This function maps
[Packer language values](/docs/hcl2/expressions#types-and-values)
...
[`jsonencode`](/docs/hcl2/functions/encoding/jsonencode) instead: YAML flow-style is a superset
of JSON syntax.

## Related Functions

- [`jsonencode`](/docs/hcl2/functions/encoding/jsonencode) is a similar operation using JSON instead
  of YAML.
- [`yamldecode`](/docs/hcl2/functions/encoding/yamldecode) performs the opposite operation, _decoding_
