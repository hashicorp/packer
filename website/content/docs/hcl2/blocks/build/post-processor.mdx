...
block](/docs/hcl2/blocks/build/post-processor) list, that is a list of
...
Variables](/docs/hcl2/contextual-variables) documentation to learn more
about and see some examples of how to use them.

### Related

- The [`post-processors` block](/docs/hcl2/blocks/build/post-processor)
