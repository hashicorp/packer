...
`@include 'hcl2/contextual-source-variables.mdx'`
...
All build variables are valid to use with any of the [HCL2 functions](/docs/hcl2/functions).
Example of using [upper](/docs/hcl2/functions/string/upper) to upper case the build ID:
