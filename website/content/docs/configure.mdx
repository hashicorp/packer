...
The home directory of packer will be in the `/.packer.d/` directory of the first
one of the following env values to be set :
...
-> Note: On this page, `PACKER_HOME_DIR` is [Packer's home
