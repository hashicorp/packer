...
has. In other word, currently `packer init` is only in charge of installing
packer plugins.
...
-> **Note:** Packer init does not work with legacy JSON template. You can
upgrade your JSON configfiles to HCL using the hcl2ugprade command.
