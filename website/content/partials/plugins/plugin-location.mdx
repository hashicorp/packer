...
1. The `PACKER_HOME_DIR/plugins` directory. PACKER_HOME_DIR refers to _[Packer's home
   directory](/docs/configure#packer-s-home-directory)_, if it could be found.
