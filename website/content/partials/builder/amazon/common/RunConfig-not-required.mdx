...
- `http_endpoint` (string) - Metadata settings
...
- `http_tokens` (string) - A string to enable or disble the IMDS endpoint for an instance. Defaults to enabled.
  Accepts either "enabled" or "disabled"

- `http_put_response_hop_limit` (int64) - A string to either set the use of IMDSv2 for the instance to optional or required. Defaults to "optional".
